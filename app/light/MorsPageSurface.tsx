    ...
    >
      <header className="page-header">
        <div className="page-brand">
          <span className="page-logo-wrap">
            ...
            <img src={`${BASE_PATH}/yzs-mark.png`} alt="" />
          </span>
          <span>杨子硕</span>
          <span className="page-brand-suffix">YZS · PORTFOLIO</span>
        </div>
        <div className="page-status"><span /> 作品陆续上传中</div>
      </header>

      <div className="page-main">
        <section className="page-copy" aria-labelledby={titleId}>
          <p className="page-kicker">01 / 作品集 · 2026</p>
          <h1 id={titleId}>
            光亮起的地方，<br />
            就是<span>作品的入口。</span>
          </h1>
          <p className="page-subtitle">
            杨子硕的作品集。向下滚动，让这盏灯越来越亮，照亮整间屋子——作品就在灯下。
          </p>

          <div className="concepts" data-interactive>
            <div className="concept-list" role="list" aria-label="作品方向">
      ...
      <footer className="page-footer">
        ...
        <div className="drag-instruction">
          ...
          <div><b>左键拉灯 · 右键调光</b><span>右键拖动调光束 · 右键单击换颜色</span></div>
        </div>
        <p>杨子硕 © 2026 — 作品集搭建中</p>
      </footer>
    </div>
...
export function MorsLightLoading() {
  return (
    <section className="experience-shell" aria-label="灯光交互首页">
      <MorsLightPreview />
